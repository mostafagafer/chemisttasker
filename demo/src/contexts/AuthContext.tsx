...
export function AuthProvider({ children }: AuthProviderProps) {
  ...
  useEffect(() => {
    // DEMO MODE: Auto-login as Owner if no user is stored
    const storedUser = localStorage.getItem("user");
    if (!storedUser) {
      // Set demo credentials automatically
      ...
      const demoUser: User = {
        ...
        memberships: [
          { pharmacy_id: 101, pharmacy_name: "Demo Pharmacy City", role: "OWNER" },
          { pharmacy_id: 102, pharmacy_name: "Demo Pharmacy Coast", role: "OWNER" },
          { pharmacy_id: 103, pharmacy_name: "Demo Pharmacy Suburbs", role: "OWNER" },
        ],
        admin_assignments: [],
      ...
      setAccess("demo-access-token");
      setRefresh("demo-refresh-token");
      setUser(demoUser);
      setIsLoading(false);
      return;
    }
